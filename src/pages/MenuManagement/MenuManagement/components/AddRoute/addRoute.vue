        ...
        <template #body>
            <div class="dialog-body">
                ...
                <t-form-item :label="$t('menuDialog.componentAddress')" name="component_address">
                    <t-select :disabled="formData.menu_type === 0" v-model="formData.component_address" :placeholder="$t('menuDialog.componentAddressPlaceholder')"
                        :filter="(query, option) => option.value.includes(query)"
                    >
